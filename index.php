...
<body>
  <div class="navigationclass">
              ...
              <div class="col s12">
                <a href="#!" data-target="slide-out" class="sidenav-trigger black-text left hide-on-medium-and-up button-collapse"><i
                  ...
                  <ul class="right hide-on-med-and-down">
                    <li>
                      <a href="#home_section" class="black-text">Home</a>
                    </li>
                    <li>
                      <a  href="#about_section" class="black-text">About</a>
                    </li>
                    <li>
                      <a href="#prize_section"  class="black-text">Prizes</a>
                    </li>
                    <li>
                      <a  href="#rules_section" class="black-text">Rules</a>
                    </li>
                    <li>
    ...
    <div class="parallax-container" id="home_section">
    ...
    <section style="padding-top: 10px" class="center section" id="about_section">
      <div class="row">
        <div class="col s12 m7 center-align">
          <div class="card bordered" style="background-color:#0070c0">
            <div class="card-content white-text center">
              <span class="card-title" style="font-weight: bold;font-size: 30px">About the Event</span>
              <p class="white black-text bordered" style="padding:10px">
                Appathon is a Android application Development Hack-a-thon Organized by Developer Student Club, Computer Science and Engineering Department Chandigarh University<br> This year, We bring to you the perfect opportunity to participate and show your potential and limitless creativity to solve real-world problems in the best magic CSE student can do!
                <br>
    ...
    <section class="section" id="problem_section">
      <div class="row">
    ...
    <div class="row" id="prize_section">
        ...
        <div class="card bordered hoverable grey darken-3">
          <div class="card-content white-text center">
            ...
            <ul class="collection white black-text bordered" style="padding:10px">
              ...
              <li class="collection-item">Last date for applying is 24-March</li>
            </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col s12 m6 ">
            <div class="card-panel hoverable inherit-padding grad2 bordered z-depth-1">
              <div class="row valign-wrapper">
                <div class="col s4">
                  <img src="./images/people/jasneet1.jpeg" alt="" class="circle responsive-img" alt="Jasneet kaur">
                </div>
                <div class="col s8">
                  <span class="white-text">
                    <h5>Jasneet Kaur</h5>
          ...
          <div class="col s12 m6">
            <div class="card-panel hoverable inherit-padding grad3 bordered z-depth-1">
              <div class="row valign-wrapper">
                <div class="col s4">
                  <img src="./images/people/anjum.jpeg" alt="" class="circle responsive-img" alt="anjum md.">
                </div>
                <div class="col s8">
                  <span class="white-text">
                    <h5>Anjum Md.</h5>
                    <p>anjummohdaslam.cse@cumail.in</p>
                  </span>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col s12 m6">
            <div class="card-panel hoverable inherit-padding grad5 bordered z-depth-1">
              <div class="row valign-wrapper">
                <div class="col s4">
                  <img src="./images/people/deepak.jpg" alt="" class="circle responsive-img" alt="Deepak Yadav DSC lead by Google">
                </div>
                <div class="col s8">
                  <span class="white-text">
                    <h5>Deepak Yadav</h5>
          ...
          <div class="col s12 m6">
            <div class="card-panel hoverable inherit-padding grad4 bordered z-depth-1">
              <div class="row valign-wrapper">
                <div class="col s4">
                  <img src="./images/people/bhaskar.jpeg" alt="" class="circle responsive-img" alt="Bhaskar Kumar">
                </div>
                <div class="col s8">
                  <span class="white-text">
                    <h5>Bhaskar Kumar</h5>
            ...
            <div class="row">
              <form class="col s12" method="POST">
                <div class="row">
                  ...
                  <div class="col s12 center">
                    <input type="submit" name="submit"  class="btn btn-large center grad5 waves-effect waves-light bordered" value="Submit">
                  </div>
                </div>
              </form>
            </div>
